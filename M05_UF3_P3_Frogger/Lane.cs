...
namespace M05_UF3_P3_Frogger
{
    public class Lane
    {
        ...
        public Lane(int posY, bool speedPlayer, ConsoleColor background, bool damageElements, bool damageBackground, float elementsPercent, char elementsChar, ConsoleColor[] colorsCars)
        {
            this.posY = posY;
            this.speedPlayer = speedPlayer;
            this.background = background;
